...
const BrandLife = () => {
  ...
  const images = [
    { src: img1, id: 1, title: translation[lang].main_page.brand_nature },
    { src: img2, id: 1, title: translation[lang].main_page.brand_look },
    { src: img2, id: 1, title: translation[lang].main_page.brand_idea },
  ]
    ...
    <section className={styles.brands}>
      <div className={`container ${styles.brands__container}`}>
        <h2 className={`site-title ${styles.brands__title}`}>
          {translation[lang].main_page.brand_title}
        </h2>
          ...
          <ul className={`list-reset ${styles.brands__list}`}>
            <li className={styles.brands__list__item}>
              ...
              >
                <Image
                  src={img1}
                  alt={translation[lang].main_page.brand_nature}
                  className='transition-opacity opacity-0 duration'
                  onLoad={handleLoadingImageComplete}
                />
                <span>
                  {textWithNonBreakingSpace(
                    translation[lang].main_page.brand_nature
                  )}
                </span>
              </Link>
            </li>
            <li className={styles.brands__list__item}>
              ...
              >
                <Image
                  src={img2}
                  alt={translation[lang].main_page.brand_look}
                  className='transition-opacity opacity-0 duration'
                  onLoad={handleLoadingImageComplete}
                />
                <span>
                  {textWithNonBreakingSpace(
                    translation[lang].main_page.brand_look
                  )}
                </span>
              </Link>
            </li>
            <li className={styles.brands__list__item}>
              ...
              >
                <Image
                  src={img2}
                  alt={translation[lang].main_page.brand_idea}
                  className='transition-opacity opacity-0 duration'
                  onLoad={handleLoadingImageComplete}
                />
                <span>
                  {textWithNonBreakingSpace(
                    translation[lang].main_page.brand_idea
                  )}
                </span>
              </Link>
            </li>
